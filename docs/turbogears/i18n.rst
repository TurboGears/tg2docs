...
messages to a POT file in your project's i18n directory.  Don't forget to
add the generated catalog files to your revision control system if you use
one.
...
Create a catalog for a new locale with the following command::
  ...
  gearbox i18n init -l [country code]
...
command::
  ...
  gearbox i18n update -l [country code]
