# -*- coding: utf-8 -*-
#
# TurboGears documentation build configuration file
#
...
private_index = 'http://tg.gy/' + version.replace('.', '')

# replace references to the private index with the actual value
rst_epilog = '''

.. |private_index_path| replace:: %s
''' % private_index
...
latex_documents = [
  ('index', 'TurboGears.tex', u'TurboGears Documentation',
   u'The TurboGears Doc Team', 'manual'),
]
...
epub_post_files = []
epub_exclude_files = [
    '_static/doctools.js', '_static/jquery.js', '_static/sidebar.js',
    '_static/searchtools.js', '_static/underscore.js',
    '_static/screenshot.tiff', '_static/turbogears.pdf',
    '_static/trunk.zip',
    '_static/ToscaWidgetsFormsExample.zip', '_static/Wiki20_final.zip',
    '_static/tutorials/Helloworld.zip', '_static/tutorials/Wiki-20.zip',
...
man_pages = [
    ('index', 'turbogears', u'TurboGears Documentation',
     [u'The TurboGears Doc Team'], 1)
]
...
# Ihe options for the TurboGears code documentation extensions

code_scm = 'svn'
code_path = test_path = 'project_code'
