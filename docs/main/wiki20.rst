...
You'll be prompted for the name of the project, and the name of the python package.
...
the ``paster setup-app`` command where your application configuration file is available
